...
public class PeripheralPanelController implements Initializable, BaseController {
    ...
    @FXML
    private DisplayConfig customerDisplay;
    @FXML
    private PrinterConfig printer1;
    @FXML
    private PrinterConfig printer2;
    @FXML
    private PrinterConfig printer3;
    @FXML
    private PrinterConfig printer4;
    @FXML
    private PrinterConfig printer5;
    @FXML
    private PrinterConfig printer6;
    @FXML
    private DeviceConfig scale;
    @FXML
    private ScannerConfig scanner;
    @FXML
    private LabeledComboBox reportPrinter;
