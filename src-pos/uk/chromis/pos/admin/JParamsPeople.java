...
public class JParamsPeople extends javax.swing.JPanel implements ReportEditorCreator {
    ...
    public JParamsPeople(Boolean allSites) {
    ...
    public void init(AppView app) {
        ...
        try {
            rightsLevel = ((Integer.parseInt(dlAdmin.getRightsLevelByID(app.getAppUserView().getUser().getRole(), dlSync.getSiteGuid()))));
        } catch (BasicException ex) {
            Logger.getLogger(JParamsPeople.class.getName()).log(Level.SEVERE, null, ex);
        }
