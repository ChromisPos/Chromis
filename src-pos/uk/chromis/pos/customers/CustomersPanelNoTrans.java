...
public class CustomersPanelNoTrans extends JPanelTable2 {
    ...
    protected void init() {
        ...
        m_paramsSite.addActionListener(new CustomersPanelNoTrans.ReloadActionListener());
        ...
        lpr = new ListProviderCreator(new PreparedSentence(app.getSession(),
                ...
                new CustomersPanelNoTrans.CustomersPanelNoTransSerializerRead()
        ),
                m_paramsSite);
        ...
        jeditor = new CustomersViewNoTrans(app, dirty, dlSync.getSiteGuid());
    }
    ...
    private class ReloadActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                CustomersPanelNoTrans.this.bd.actionLoad();
            } catch (BasicException w) {
            }
        }
    }

    private class CustomersPanelNoTransSerializerRead implements SerializerRead {
