...
public class ProductInfoExt {
    ...
    protected Double m_dCommission;
    ...
    protected Integer m_jDefaultPtr;
    protected Integer m_jDefaultScreen;
    protected Boolean m_jRemoteDisplay;
    protected Boolean m_jPtrOverride;    
    protected String m_siteguid;
    ...
    public ProductInfoExt() {
        ...
        m_jDefaultPtr = 0;
        m_jDefaultScreen = 0;
        m_jRemoteDisplay = false;
        m_jPtrOverride = false;
    }

    public Integer getDefaultPtr() {
        return m_jDefaultPtr;
    }

    public void setDefaultPtr(Integer ptr) {
        this.m_jDefaultPtr = ptr;
    }

    public Integer getDefaultScreen() {
        return m_jDefaultScreen;
    }

    public Boolean getPtrOverride() {
        return m_jPtrOverride;
    }

    public void setPtrOverride(Boolean ptrOverride) {
        this.m_jPtrOverride = ptrOverride;
    }

    public void setDefaultScreen(Integer screen) {
        this.m_jDefaultScreen = screen;
    }
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() {
            ...
            public Object readValues(DataRead dr) throws BasicException {
                ...
                product.m_jDefaultPtr = dr.getInt(DataLogicSales.INDEX_DEFAULTPTR + 1);
                product.m_jRemoteDisplay = dr.getBoolean(DataLogicSales.INDEX_REMOTEDISPLAY + 1);
                product.m_jDefaultScreen = dr.getInt(DataLogicSales.INDEX_DEFAULTSCREEN + 1);
                product.m_jPtrOverride = dr.getBoolean(DataLogicSales.INDEX_PTROVERRIDE + 1);
