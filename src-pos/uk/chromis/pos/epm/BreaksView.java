...
public final class BreaksView extends javax.swing.JPanel implements EditorRecord {
    ...
    public BreaksView(AppView app, DirtyManager dirty, String localGuid) {
    ...
    public void writeValueEdit(Object value) {
        ...
        m_jVisible.setSelected(((Boolean) breaks[3]));
        m_jBreakName.setEditable(true);
        m_jBreakDescription.setEnabled(true);
        m_jVisible.setEnabled(true);
        siteGuid = breaks[4].toString();
    }
    ...
    public Object createValue() throws BasicException {
        ...
        breaks[3] = m_jVisible.isSelected();
        breaks[4] = siteGuid;
        return breaks;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("label.epm.name")); // NOI18N
