...
public final class LeavesView extends javax.swing.JPanel implements EditorRecord {
    ...
    private final DataLogicPresenceManagement dlPresenceManagement;

    public LeavesView(AppView app, DirtyManager dirty, String localGuid) {
...
// TODO - rewrite IsValidStartDate using Apache commons or Calendar 
    ...
    private void btnEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmployeeActionPerformed
        ...
        JEmployeeFinder finder = JEmployeeFinder.getEmployeeFinder(this, dlPresenceManagement, siteGuid);
        finder.search(null);
