...
public class JEmployeeFinder extends javax.swing.JDialog implements EditorCreator {
     ...
     * @return
     */
    public static JEmployeeFinder getEmployeeFinder(Component parent, DataLogicPresenceManagement dlPresenceManagement, String guid) {
        ...
        myMsg.init(dlPresenceManagement, guid);
    ...
    private void init(DataLogicPresenceManagement dlPresenceManagement, String siteGuid) {
        initComponents();
         this.siteGuid = siteGuid;
        jScrollPane1.getVerticalScrollBar().setPreferredSize(new Dimension(35, 35));
        m_jtxtName.addEditorKeys(m_jKeys);
        m_jtxtName.reset();
        lpr = new ListProviderCreator(dlPresenceManagement.getEmployeeList(siteGuid), this);
