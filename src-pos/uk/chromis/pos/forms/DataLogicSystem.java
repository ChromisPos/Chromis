...
public class DataLogicSystem extends BeanFactoryDataSingle {
    ...
    public void init(Session s) {
        ...
        m_versionint = new PreparedSentence(s, "SELECT VERSIONINT FROM APPLICATIONS WHERE ID = ?", SerializerWriteString.INSTANCE, SerializerReadString.INSTANCE);
...
// added 17.12.2016 update import profile         
    ...
    public final Integer findVersionInt() throws BasicException {
        return (Integer) m_versionint.find(AppLocal.APP_VERSIONINT);
    }
