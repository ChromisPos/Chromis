...
public class ScriptletUtil {
    ...
    public String printAddi(int paramInt) {
        ...
        try {
            ...
            Logger.getLogger(com.openbravo.util.pos.ScriptletUtil.class.getName()).log(Level.SEVERE, null, localException1);
        }
        String str2 = "";
        try {
            ...
            Logger.getLogger(com.openbravo.util.pos.ScriptletUtil.class.getName()).log(Level.SEVERE, null, localException2);
        }
        return str2;
    }
    ...
    public int countAddi(int paramInt) {
        ...
        try {
            ...
            Logger.getLogger(com.openbravo.util.pos.ScriptletUtil.class.getName()).log(Level.SEVERE, null, localException);
        }
        return i;
    }
    ...
    public Session getSession() {
        if (this.session == null) {
            ...
            try {
                ...
                Logger.getLogger(com.openbravo.util.pos.ScriptletUtil.class.getName()).log(Level.SEVERE, null, localSQLException);
            }
        }
        return this.session;
    }
